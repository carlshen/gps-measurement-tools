...
public class TimerFragment extends DialogFragment {
  private TimerService.TimerListener mListener;
  ...
  public void onAttach(Activity activity) {
    ...
    checkState(
        getTargetFragment() instanceof TimerService.TimerListener,
        "Target fragment is not instance of TimerListener");

    mListener = (TimerService.TimerListener) getTargetFragment();
  }
